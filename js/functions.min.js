...
function toggle_main_menu() {
    if (viewport().width <= window.xs_screen_max) {
        var t = $("#left-sidebar #mobile-menu-icon"),
            e = $("#left-sidebar #main-menu");
...
function sections_content_vertical_position() {
    ...
    } else $("#main-content .section-wrapper .content-wrapper").css({
        position: "static"
    })
}
...
function set_section_to_active(t, e, i, a) {
    if (void 0 !== t && "" != t) {
        ...
        if ("" != s && 0 != s.length) s.addClass("active");
            ...
            var o = t.substr(1);
            $("#main-menu #menu-item-" + o + ".menu-item").addClass("active")
...
function update_active_sections_on_scroll(t, e) {
    var i = void 0 !== t && "" != t ? t : $("#main-content").find(".section-wrapper"),
